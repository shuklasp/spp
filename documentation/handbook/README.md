...
These older branch documents remain available as supporting material. The newer expanded chapters below are the preferred learning entry points.
...
### Canonical expanded teaching branches
...
flowchart TD
    ...
    AA --> AB[Same-problem comparisons and anti-patterns]
