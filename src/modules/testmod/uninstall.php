 ...
 * uninstall.php
 * 
 * Executed ONLY once when the module is uninstalled via `php spp.php module:uninstall testmod`.
 * Use this file to:
...
// Example: $db->execute_query("DELETE FROM settings WHERE key = ?", ['testmod_active']);