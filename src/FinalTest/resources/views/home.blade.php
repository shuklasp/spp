{{--
  ...
  Edit this file: src/FinalTest/resources/views/home.blade.php
--}}
@extends('layouts.app')
...
@section('content')
    ...
    <div class="card">
        ...
        <p>This form is defined in <code>etc/apps/FinalTest/forms/contact.yml</code> and rendered via <code>@sppform</code>:</p>
        @sppform('contact')
    </div>
