 ...
 *      - Place in src/FinalTest/tests/ directory
 *
 ...
 *
 * RUNNING TESTS:
 *   php spp.php test:run --app=FinalTest
 *   php spp.php test:run --app=FinalTest --coverage   (with code coverage)
 *   php spp.php test:run --app=FinalTest EntityName    (test single entity)
 *
 ...
 *   4. Run: php spp.php test:run --app=FinalTest
 * ============================================================================
 */
