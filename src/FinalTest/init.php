...
/**
 * ============================================================================
 * Application Boot — FinalTest
 * ============================================================================
 *
 * HOW THIS WORKS:
 * This file is loaded automatically by the SPP framework during bootstrap
 * when the 'FinalTest' application context is active. It runs ONCE per request.
 *
 * USE THIS FOR:
...
// Maps the \App\FinalTest\ namespace to this app's directory.
// This allows you to use classes like \App\FinalTest\Serv\HomeController
spl_autoload_register(function ($className) {
    // Only handle our app namespace
    $prefix = 'App\\FinalTest\\';
...
//     // Custom 404 handling
//     echo "<h1>Page not found in FinalTest</h1>";
// });
//
...
if (php_sapi_name() !== 'cli' && class_exists('\\SPPMod\\Drishyam\\SPPUX')) {
    \SPPMod\Drishyam\SPPUX::boot('FinalTest');
}
