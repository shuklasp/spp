 ...
 * SPPBlade looks for templates in: src/FinalTest/resources/views/
 ...
 *   3. Add route in pages.yml: mypage: { controller: \App\FinalTest\Serv\HomeController@mypage }
 * ============================================================================
 */
class HomeController
{
    ...
    public function guide()
    {
        return $this->render('guide', [
            'title' => 'FinalTest Developer Guide',
        ]);
    }
    ...
    protected function render(string $view, array $data = []): string
    {
        ...
        $data['app_name'] = 'FinalTest';
        $data['base_url'] = \SPP\App::getBaseUrl('FinalTest');
