/**
 * ============================================================================
 * Main Dashboard Component — FinalTest
 * ============================================================================
 *
...
export default class Main extends BaseComponent {
    ...
    async onInit() {
        this.setState({
            appName: this.props.appName || 'FinalTest',
            activeTab: 'welcome',
            items: [],
            loading: false,
        ...
        SPPUX.openSubEditor('Enterprise Settings', `
            <div style="color: var(--sppux-text, #fff); font-family: 'Inter', sans-serif;">
                ...
                <div style="margin-top: 1.5rem;">
                    ...
                    <input type="text" value="FinalTest Production Cluster" style="width: 100%; padding: 0.8rem 1rem; margin-top: 0.5rem; border-radius: 10px; border: 1px solid var(--sppux-primary, #6366f1); background: rgba(0,0,0,0.2); color: #fff; font-family: inherit; font-size: 0.95rem;">
                </div>
                <div style="margin-top: 1.5rem;">
        ...
        return html`
            <div>
                ...
                <div style="padding:1rem; background:var(--sppux-card-bg, rgba(255,255,255,0.03)); border-radius:10px; font-family:monospace; font-size:0.85rem; line-height:1.8; overflow-x:auto;">
                    ...
                    <span style="opacity:0.5;">// The PHP service is at: src/FinalTest/serv/task_create.php</span><br>
                    <span style="opacity:0.5;">// Registered in: src/FinalTest/etc/services.yml</span>
                </div>
