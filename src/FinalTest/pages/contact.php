 ...
 * The form is defined in etc/apps/FinalTest/forms/contact.yml
 */
...
<div style="max-width: 700px; margin: 2rem auto; padding: 0 1rem;">
    <div style="background: #fff; border-radius: 16px; padding: 2.5rem; box-shadow: 0 4px 20px rgba(0,0,0,0.04); border: 1px solid #e2e8f0;">
        ...
        <p style="color: #64748b;">This form is powered by the SPP YAML form engine. Definition: <code>etc/apps/FinalTest/forms/contact.yml</code></p>
