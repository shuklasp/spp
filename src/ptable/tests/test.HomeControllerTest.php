 ...
 *      - Place in src/ptable/tests/ directory
 *
 ...
 *
 * RUNNING TESTS:
 *   php spp.php test:run --app=ptable
 *   php spp.php test:run --app=ptable --coverage   (with code coverage)
 *   php spp.php test:run --app=ptable EntityName    (test single entity)
 *
 ...
 *   4. Run: php spp.php test:run --app=ptable
 * ============================================================================
 */
