...
/**
 * ============================================================================
 * ptable — SPP-UX Single Page Application Entry Point
 * ============================================================================
 *
 * HOW THIS WORKS:
...
<head>
    ...
    <title><?php echo 'ptable'; ?> — SPP-UX Application</title>
...
<body>
    ...
    <div data-spp-component="1"
         ...
         data-spp-props='{"appName":"<?php echo 'ptable'; ?>", "appRoot":"<?php echo \SPP\App::getBaseUrl(); ?>"}'>
        <!-- This content shows while the component loads -->
        <div class="spp-app-loading">
            <div class="spinner"></div>
            <span>Loading <?php echo 'ptable'; ?>...</span>
        </div>
    </div>
