...
<head>
    ...
    <title>@yield('title', 'ptable')</title>
    ...
    <link rel="stylesheet" href="{{ $base_url ?? '/ptable' }}/theme-assets/default/custom.css?v={{ time() }}">
...
<body>
    <nav class="nav">
        <div class="layout-container nav-inner">
            <a href="@url('')" class="nav-brand">
                ...
                <span style="background: linear-gradient(135deg, var(--primary), #8b5cf6); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">Periodic Table</span>
            </a>
            <div class="nav-links">
                <a href="@url('')">Explore</a>
                <a href="@url('compounds')">Compounds</a>
    ...
    <footer class="footer">
        <div class="layout-container">
            &copy; {{ date('Y') }} ptable &bull; Built with SPP Framework
        </div>
    </footer>
