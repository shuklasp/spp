...
<head>
    ...
    <title>@yield('title', 'test_api_app')</title>
...
<body>
    <nav class="nav">
        <div class="layout-container nav-inner">
            <a href="{{ $base_url }}" class="nav-brand">🚀 test_api_app</a>
            <div class="nav-links">
    ...
    <footer class="footer">
        <div class="layout-container">
            &copy; {{ date('Y') }} test_api_app &bull; Built with SPP Framework
        </div>
    </footer>
