 ...
 *
 * Generated for application: test_api_app
 *
 * HOW THIS PAGE WORKS:
 *   - This is a "native PHP page" rendered by the SPP view layer
 *   - It is mapped in etc/apps/test_api_app/pages.yml as:
 *       guide:
 *         url: pages/guide.php
...
<div style="max-width: 1100px; margin: 2rem auto; padding: 0 1rem; font-family: Inter, -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif;">
    <div style="background: #fff; border-radius: 16px; padding: 2.5rem; box-shadow: 0 4px 20px rgba(0,0,0,0.04); border: 1px solid #e2e8f0;">
        ...
        <p style="color: #94a3b8; font-size: 0.95rem; margin-bottom: 2.5rem;">Application: <code style="background:#f1f5f9;padding:2px 8px;border-radius:6px;">test_api_app</code> &mdash; Everything a complete novice needs to build any workflow</p>
        ...
        <p style="color:#475569; line-height:1.8;">
            ...
            <code>native</code> (raw PHP), <code>api</code> (headless REST), <code>dropin</code> (low-code HTML/PHP). Your app is: <code>test_api_app</code>.
        </p>
        ...
        <p style="color:#475569; line-height:1.8;">Every SPP app has two main directories: <code>etc/apps/test_api_app/</code> for configuration, and <code>src/test_api_app/</code> for source code.</p>
...
your-project/
├── etc/apps/test_api_app/         # ── CONFIGURATION ──
...
└── spp/                           # Framework core (do not modify)
    ...
    └── etc/global-settings.yml    # All apps registered here</pre>
        ...
        <p style="color:#475569; line-height:1.8;">Routes are defined in <code>etc/apps/test_api_app/pages.yml</code>. SPP supports five route types:</p>

        <h3 style="color:#475569; margin-top:1.5rem;">3a. pages.yml Route Types</h3>
        <pre style="background:#0f172a; color:#e2e8f0; padding:1.2rem; border-radius:10px; overflow-x:auto; font-size:0.82rem; line-height:1.7;">
# ── etc/apps/test_api_app/pages.yml ──

defaults:
  home: home                              # Default page when no route matches
  pagedir: /src/test_api_app              # Base directory for page files
...
pages:
  ...
  api/v1/items/{id}:
    controller: \App\test_api_app\Serv\ApiController@show</pre>
...
// Cache file: var/cache/routes_test_api_app.php</pre>
        ...
        <p style="color:#475569; line-height:1.8;">Controllers live in <code>src/test_api_app/serv/</code>. They handle requests and return either rendered Blade HTML or JSON data.</p>
        <pre style="background:#0f172a; color:#e2e8f0; padding:1.2rem; border-radius:10px; overflow-x:auto; font-size:0.82rem; line-height:1.7;">
// ── src/test_api_app/serv/HomeController.php ──
...
class HomeController
{
    ...
    // run('viewName', $data) renders resources/test_api_app/views/viewName.blade.php
    ...
    {
        // ... save data ...
        header('Location: /test_api_app/home');
        exit;
    }
}</pre>
        ...
        <p style="color:#475569; line-height:1.8;">Blade is the template engine (from Laravel, extended by SPP). Templates live in <code>resources/test_api_app/views/</code>.</p>

        <h3 style="color:#475569; margin-top:1.5rem;">5a. Layout System</h3>
        <pre style="background:#0f172a; color:#e2e8f0; padding:1.2rem; border-radius:10px; overflow-x:auto; font-size:0.82rem; line-height:1.7;">
{{-- ── resources/test_api_app/views/layout.blade.php ── --}}
&lt;!DOCTYPE html&gt;
&lt;html&gt;
&lt;head&gt;
...
{{-- ── resources/test_api_app/views/home.blade.php ── --}}
...
@endsection</pre>
        ...
        <p style="color:#475569; line-height:1.8;">SPP-UX is the reactive component system. Components are JavaScript classes in <code>src/test_api_app/comp/</code>.</p>
        <pre style="background:#0f172a; color:#e2e8f0; padding:1.2rem; border-radius:10px; overflow-x:auto; font-size:0.82rem; line-height:1.7;">
// ── comp/my-counter.js ──
...
// Themes defined in resources/test_api_app/themes/ with theme.yml</pre>
...
\SPP\SPPEvent::listen('PageNotFound', [new \App\test_api_app\Events\ErrorHandler(), 'onNotFound']);
...
events:
  - event: "AppBoot"
    handler: "App\test_api_app\Events\AppBootHandler::onBoot"
  - event: "PageNotFound"
    handler: "App\test_api_app\Events\ErrorHandler::onNotFound"
  - event: "core.error.exception"
    handler: "App\test_api_app\Events\ErrorHandler::onException"</pre>
        ...
        <pre style="background:#0f172a; color:#e2e8f0; padding:1.2rem; border-radius:10px; overflow-x:auto; font-size:0.82rem; line-height:1.7;">
# ── etc/apps/test_api_app/services.yml ──
services:
  - name: "task.create"
    script: "src/test_api_app/serv/task_create.php"
  - name: "task.list"
    script: "src/test_api_app/serv/task_list.php"
...
// ── PHP (src/test_api_app/serv/task_create.php) ──
...
try {
    ...
    return $blade-&gt;run('error', ['message' =&gt; 'Something went wrong']);
        ...
        <pre style="background:#0f172a; color:#e2e8f0; padding:1.2rem; border-radius:10px; overflow-x:auto; font-size:0.82rem; line-height:1.7;">
// ── src/test_api_app/middleware/AuthGuard.php ──
namespace App\test_api_app\Middleware;
...
class AuthGuard
{
    ...
    public function handle($request, $next)
    {
        if (!\SPPMod\SPPAuth\SPPAuth::isLoggedIn()) {
            header('Location: /test_api_app/login');
            exit;
        }
...
// ── etc/apps/test_api_app/middleware.yml (global pipeline) ──
middleware:
  global:
    - \App\test_api_app\Middleware\CorsMiddleware
    - \App\test_api_app\Middleware\SessionMiddleware
  groups:
    auth:
      - \App\test_api_app\Middleware\AuthGuard
    api:
      - \App\test_api_app\Middleware\ApiRateLimit

// Per-route middleware (in pages.yml):
// dashboard:
//   controller: \App\test_api_app\Serv\DashboardController@index
//   middleware: [auth]
...
// Each middleware calls $next() to pass to the next one.</pre>
        ...
        <pre style="background:#0f172a; color:#e2e8f0; padding:1.2rem; border-radius:10px; overflow-x:auto; font-size:0.82rem; line-height:1.7;">
// ── Creating an Entity ──
// Run: php spp.php make:entity --app=test_api_app Task
// This creates src/test_api_app/entities/Task.php

namespace App\test_api_app\Entities;

class Task extends \SPPMod\SPPDB\Entity
{
    protected string $table = 'test_api_app_tasks';  // Uses table prefix
...
// ── Migrations ──
// php spp.php migrate --app=test_api_app
// php spp.php migrate:rollback --app=test_api_app
// php spp.php db:seed --app=test_api_app</pre>
        ...
        <pre style="background:#0f172a; color:#e2e8f0; padding:1.2rem; border-radius:10px; overflow-x:auto; font-size:0.82rem; line-height:1.7;">
# ── etc/apps/test_api_app/forms/contact.yml ──
id: contact
...
if ($result['success']) {
    header('Location: /test_api_app/dashboard');
}
...
//   session_save_path: tcp://127.0.0.1:6379</pre>
        ...
        <pre style="background:#0f172a; color:#e2e8f0; padding:1.2rem; border-radius:10px; overflow-x:auto; font-size:0.82rem; line-height:1.7;">
// ── Language files: resources/test_api_app/lang/en.json ──
{
...
// ── resources/test_api_app/lang/es.json ──
{
...
Container::bind('mailer', function() {
    return new \App\test_api_app\Services\MailService();
});

// ── Singleton (same instance every time) ──
Container::singleton('cache', function() {
    return new \App\test_api_app\Services\CacheService();
});
...
// File naming: test.TaskTest.php in src/test_api_app/tests/</pre>
...
// Also: -&gt;toBeTrue(), -&gt;toBeFalse(), -&gt;toBeNull(), -&gt;toContain()</pre>
        ...
        <pre style="background:#0f172a; color:#e2e8f0; padding:1.2rem; border-radius:10px; overflow-x:auto; font-size:0.82rem; line-height:1.7;">
php spp.php test:run --app=test_api_app               # Run full test suite
php spp.php test:run --app=test_api_app --coverage    # With code coverage report
php spp.php test:run --app=test_api_app TaskTest      # Run single test class
php spp.php test:blueprint --app=test_api_app          # Auto-generate test stubs
php spp.php test:monkey --app=test_api_app             # Fuzz/monkey testing
php spp.php test:evolve --app=test_api_app             # Evolutionary testing</pre>

        <!-- ================================================================ -->
        <!-- SECTION 19: Themes -->
        <!-- ================================================================ -->
        <h2 style="color:#6366f1; margin-top:2.5rem; border-bottom: 2px solid #e2e8f0; padding-bottom: 0.5rem;">19. Themes</h2>
        <p style="color:#475569; line-height:1.8;">Themes are defined in <code>resources/test_api_app/themes/</code> with a <code>theme.yml</code> config.</p>
        <pre style="background:#0f172a; color:#e2e8f0; padding:1.2rem; border-radius:10px; overflow-x:auto; font-size:0.82rem; line-height:1.7;">
# ── resources/test_api_app/themes/default/theme.yml ──
name: "Default Theme"
version: "1.0"
css:
...
# ── etc/apps/test_api_app/config.yml ── (app-specific)
app:
  name: "test_api_app"
...
$value = \SPP\SPPConfig::get('app.name');       // "test_api_app"
...
// Log rotation is automatic (configurable max file size)</pre>
        ...
        <p style="color:#475569; line-height:1.8;">Follow these steps to build your first feature in <code>test_api_app</code>:</p>
        ...
        <div style="background:#f0fdf4; border-left:4px solid #22c55e; padding:1.2rem 1.5rem; border-radius:0 10px 10px 0; margin:1rem 0;">
            <ol style="color:#475569; line-height:2.2; margin:0; padding-left:1.2rem;">
                <li><b>Explore your app</b> &mdash; Visit <code>/test_api_app/home</code> in your browser</li>
                <li><b>Edit a controller</b> &mdash; Modify <code>src/test_api_app/serv/HomeController.php</code></li>
                <li><b>Edit a Blade view</b> &mdash; Modify <code>resources/test_api_app/views/home.blade.php</code></li>
                <li><b>Create an entity</b> &mdash; Run <code>php spp.php make:entity --app=test_api_app Task</code></li>
                <li><b>Run migrations</b> &mdash; Run <code>php spp.php migrate --app=test_api_app</code></li>
                <li><b>Add a new route</b> &mdash; Edit <code>etc/apps/test_api_app/pages.yml</code></li>
                <li><b>Create a YAML form</b> &mdash; Add a new file in <code>etc/apps/test_api_app/forms/</code></li>
                <li><b>Build a component</b> &mdash; Create a JS file in <code>src/test_api_app/comp/</code></li>
                <li><b>Write tests</b> &mdash; Add tests in <code>src/test_api_app/tests/</code></li>
                <li><b>Run tests</b> &mdash; <code>php spp.php test:run --app=test_api_app</code></li>
        ...
        <div style="margin-top:2rem; padding:1.5rem; background:#eff6ff; border-radius:10px; text-align:center;">
            ...
            <p style="color:#64748b; font-size:0.85rem; margin:0.5rem 0 0;">Remove the <code>'guide'</code> route from <code>etc/apps/test_api_app/pages.yml</code> and delete this file.</p>
        </div>
