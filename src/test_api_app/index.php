...
/**
 * ============================================================================
 * test_api_app — SPP-UX Single Page Application Entry Point
 * ============================================================================
 *
 * HOW THIS WORKS:
...
<head>
    ...
    <title><?php echo 'test_api_app'; ?> — SPP-UX Application</title>
...
<body>
    ...
    <div data-spp-component="1"
         ...
         data-spp-props='{"appName":"<?php echo 'test_api_app'; ?>"}'>
        <!-- This content shows while the component loads -->
        <div class="spp-app-loading">
            <div class="spinner"></div>
            <span>Loading <?php echo 'test_api_app'; ?>...</span>
        </div>
    </div>
