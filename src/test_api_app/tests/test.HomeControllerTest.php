<?php
namespace App\test_api_app\Tests;
...
/**
 * ============================================================================
 * HomeController Test — test_api_app
 * ============================================================================
 *
 ...
 *      - Place in src/test_api_app/tests/ directory
 *
 ...
 *   php spp.php test:run --app=test_api_app --coverage   (with code coverage)
 *   php spp.php test:run --app=test_api_app EntityName    (test single entity)
 *
 ...
 *   4. Run: php spp.php test:run --app=test_api_app
 * ============================================================================
 */
