...
/**
 * ============================================================================
 * Service: task.create — test_api_app
 * ============================================================================
 *
 * HOW THIS WORKS:
 ...
 *    services:
 *      - name: "my.service"
 *        script: "src/test_api_app/serv/my_service.php"
...
// $db->execute_query("INSERT INTO test_api_app_items (name, status) VALUES (?, 'active')", [$taskTitle]);
