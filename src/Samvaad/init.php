...
/**
 * ============================================================================
 * Application Boot — Samvaad
 * ============================================================================
 *
 * HOW THIS WORKS:
 * This file is loaded automatically by the SPP framework during bootstrap
 * when the 'Samvaad' application context is active. It runs ONCE per request.
 *
 * USE THIS FOR:
...
// Maps the \App\Samvaad\ namespace to this app's directory.
// This allows you to use classes like \App\Samvaad\Serv\HomeController
...
//     // Custom 404 handling
//     echo "<h1>Page not found in Samvaad</h1>";
// });
//
