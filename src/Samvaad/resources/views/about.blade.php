    ...
    <div class="card">
        ...
        <table style="width:100%; border-collapse:collapse;">
            <thead><tr style="text-align:left; border-bottom:2px solid var(--border);">
                ...
                <tr style="border-bottom:1px solid var(--border);"><td style="padding:0.8rem;"><code>comp/</code></td><td style="padding:0.8rem;">Client-Side SPP-UX Components (.js)</td><td style="padding:0.8rem;">Building reactive client-side UI mounted via data-spp-component</td></tr>
                <tr style="border-bottom:1px solid var(--border);"><td style="padding:0.8rem;"><code>components/</code></td><td style="padding:0.8rem;">Server-Side Live & Blade Components (.php / .blade.php)</td><td style="padding:0.8rem;">Server-rendered component partials, smart content negotiation, Turbo Streams</td></tr>
