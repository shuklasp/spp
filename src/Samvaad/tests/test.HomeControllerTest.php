 ...
 *      - Place in src/Samvaad/tests/ directory
 *
 ...
 *
 * RUNNING TESTS:
 *   php spp.php test:run --app=Samvaad
 *   php spp.php test:run --app=Samvaad --coverage   (with code coverage)
 *   php spp.php test:run --app=Samvaad EntityName    (test single entity)
 *
 ...
 *   4. Run: php spp.php test:run --app=Samvaad
 * ============================================================================
 */
