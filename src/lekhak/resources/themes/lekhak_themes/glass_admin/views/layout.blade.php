...
<head>
    ...
    <link rel="preload" href="{{ \SPP\App::getBaseUrl() }}/theme-assets/lekhak_themes/glass_admin/theme.css" as="style">
    <link rel="stylesheet" href="{{ \SPP\App::getBaseUrl() }}/theme-assets/lekhak_themes/glass_admin/theme.css">
    <script>
    ...
    <script type="module">
        ...
        window.openIntegratedEditor = async function(nodeId = null, targetLang = null) {
            ...
            try {
                ...
                const moduleUrl = '{{ rtrim($web_root ?? '', '/') }}/src/lekhak/comp/editor.js?' + cacheBuster;
