...
$form['components']['node_share']['page_share']['page_share_all'] = [
  ...
  '#default_value' => theme_get_setting('page_share_all', 'eduxpro'),
...
$form['components']['node_share']['page_share']['page_share_front'] = [
  ...
  '#default_value' => theme_get_setting('page_share_front', 'eduxpro'),
...
$form['components']['node_share']['page_share']['page_share_page'] = [
  ...
  '#default_value' => theme_get_setting('page_share_page', 'eduxpro'),
...
$form['components']['node_share']['page_share']['page_share_article'] = [
  ...
  '#default_value' => theme_get_setting('page_share_article', 'eduxpro'),
...
$form['components']['node_share']['page_share']['page_share_book'] = [
  ...
  '#default_value' => theme_get_setting('page_share_book', 'eduxpro'),
...
$form['components']['node_share']['page_share']['page_share_other'] = [
  ...
  '#default_value' => theme_get_setting('page_share_other', 'eduxpro'),
