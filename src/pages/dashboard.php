        ...
        <div class="container">
            ...
            <div class="d-flex align-items-center">
                <span class="me-3">Welcome,
                    <strong><?php echo htmlspecialchars($user->username ?? 'User'); ?></strong></span>
                ...
                <div class="card h-100 shadow-sm border-0">
                    <div class="card-body">
                        ...
                        <ul class="list-unstyled mt-3 mb-0">
                            <li class="mb-2"><strong>ID:</strong> <?php echo htmlspecialchars($user->id ?? 'N/A'); ?>
                            </li>
                            <li class="mb-2"><strong>Username:</strong>
                                <?php echo htmlspecialchars($user->username ?? 'N/A'); ?></li>
                            <li class="mb-2"><strong>Email:</strong>
                                <?php echo htmlspecialchars($user->email ?? 'N/A'); ?></li>
                            <li class="mb-2">
                                <strong>Status:</strong>
                                <span
                                    class="badge bg-success rounded-pill"><?php echo htmlspecialchars($user->status ?? 'active'); ?></span>
                            </li>
                        </ul>
                    </div>
                </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="card bg-dark text-white h-100 border-0 shadow hover-shadow">
                                        <div class="card-body text-center py-4">
                                            ...
                                            <p class="card-text small text-muted mb-4">Manage site content, configurations,
                                                and structural metadata.</p>
                                            <a href="<?php echo \SPP\App::getBaseUrl('lekhak'); ?>/admin"
                                                class="btn btn-light btn-rounded px-4">Open Admin</a>
                                        </div>
                                    </div>
                                </div>
                            <?php else: ?>
