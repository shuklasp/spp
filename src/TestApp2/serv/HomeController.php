 ...
 * SPPBlade looks for templates in: src/TestApp2/resources/views/
 ...
 *   3. Add route in pages.yml: mypage: { controller: \App\TestApp2\Serv\HomeController@mypage }
 * ============================================================================
 */
class HomeController
{
    ...
    public function guide()
    {
        return $this->render('guide', [
            'title' => 'TestApp2 Developer Guide',
        ]);
    }
    ...
    protected function render(string $view, array $data = []): string
    {
        ...
        $data['app_name'] = 'TestApp2';
        $data['base_url'] = \SPP\App::getBaseUrl('TestApp2');
