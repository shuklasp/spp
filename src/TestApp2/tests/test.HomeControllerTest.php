 ...
 *      - Place in src/TestApp2/tests/ directory
 *
 ...
 *
 * RUNNING TESTS:
 *   php spp.php test:run --app=TestApp2
 *   php spp.php test:run --app=TestApp2 --coverage   (with code coverage)
 *   php spp.php test:run --app=TestApp2 EntityName    (test single entity)
 *
 ...
 *   4. Run: php spp.php test:run --app=TestApp2
 * ============================================================================
 */
