{{--
  ...
  Edit this file: src/TestApp2/resources/views/home.blade.php
--}}
@extends('layouts.app')
...
@section('content')
    ...
    <div class="card">
        ...
        <p>This form is defined in <code>etc/apps/TestApp2/forms/contact.yml</code> and rendered via <code>@sppform</code>:</p>
        @sppform('contact')
    </div>
