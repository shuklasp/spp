...
/**
 * ============================================================================
 * TestApp2 — SPP-UX Single Page Application Entry Point
 * ============================================================================
 *
 * HOW THIS WORKS:
...
<head>
    ...
    <title><?php echo 'TestApp2'; ?> — SPP-UX Application</title>
...
<body>
    ...
    <div data-spp-component="1"
         ...
         data-spp-props='{"appName":"<?php echo 'TestApp2'; ?>"}'>
        <!-- This content shows while the component loads -->
        <div class="spp-app-loading">
            <div class="spinner"></div>
            <span>Loading <?php echo 'TestApp2'; ?>...</span>
        </div>
    </div>
