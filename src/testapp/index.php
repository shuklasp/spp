...
/**
 * ============================================================================
 * testapp — SPP-UX Single Page Application Entry Point
 * ============================================================================
 *
 * HOW THIS WORKS:
...
<head>
    ...
    <title><?php echo 'testapp'; ?> — SPP-UX Application</title>
...
<body>
    ...
    <div data-spp-component="1"
         ...
         data-spp-props='{"appName":"<?php echo 'testapp'; ?>", "appRoot":"<?php echo \SPP\App::getBaseUrl(); ?>"}'>
        <!-- This content shows while the component loads -->
        <div class="spp-app-loading">
            <div class="spinner"></div>
            <span>Loading <?php echo 'testapp'; ?>...</span>
        </div>
    </div>
