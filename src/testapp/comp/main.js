/**
 * ============================================================================
 * Main Dashboard Component — testapp
 * ============================================================================
 *
...
export default class Main extends BaseComponent {
    ...
    async onInit() {
        this.setState({
            appName: this.props.appName || 'testapp',
            activeTab: 'welcome',
            items: [],
            loading: false,
            theme: 'midnight',
        ...
        return html`
            <div>
                ...
                <div style="padding:1rem; background:rgba(255,255,255,0.03); border-radius:10px; font-family:monospace; font-size:0.85rem; line-height:1.8; overflow-x:auto;">
                    ...
                    <span style="opacity:0.5;">// The PHP service is at: src/testapp/serv/task_create.php</span><br>
                    <span style="opacity:0.5;">// Registered in: src/testapp/etc/services.yml</span>
                </div>
