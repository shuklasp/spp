 ...
 *      - Place in src/testapp/tests/ directory
 *
 ...
 *
 * RUNNING TESTS:
 *   php spp.php test:run --app=testapp
 *   php spp.php test:run --app=testapp --coverage   (with code coverage)
 *   php spp.php test:run --app=testapp EntityName    (test single entity)
 *
 ...
 *   4. Run: php spp.php test:run --app=testapp
 * ============================================================================
 */
