...
/**
 * ============================================================================
 * Application Boot — testapp
 * ============================================================================
 *
 * HOW THIS WORKS:
 * This file is loaded automatically by the SPP framework during bootstrap
 * when the 'testapp' application context is active. It runs ONCE per request.
 *
 * USE THIS FOR:
...
// Maps the \\App\\testapp\\ namespace to this app's directory.
// This allows you to use classes like \\App\\testapp\\Serv\\HomeController
...
//     // Custom 404 handling
//     echo "<h1>Page not found in testapp</h1>";
// });
//
...
if (php_sapi_name() !== 'cli' && class_exists('\\\\SPPMod\\\\Drishyam\\\\SPPUX')) {
    \\SPPMod\\Drishyam\\SPPUX::boot('testapp');
}
