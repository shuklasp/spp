 ...
 * SPPBlade looks for templates in: src/testapp/resources/views/
 ...
 *   3. Add route in pages.yml: mypage: { controller: \\App\\testapp\\Serv\\HomeController@mypage }
 * ============================================================================
 */
class HomeController
{
    ...
    protected function render(string \$view, array \$data = []): string
    {
        ...
        \$data['base_url'] = \\SPP\\App::getBaseUrl('testapp');
