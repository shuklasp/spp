 ...
 *      - Place in src/SPPDocs/tests/ directory
 *
 ...
 *
 * RUNNING TESTS:
 *   php spp.php test:run --app=SPPDocs
 *   php spp.php test:run --app=SPPDocs --coverage   (with code coverage)
 *   php spp.php test:run --app=SPPDocs EntityName    (test single entity)
 *
 ...
 *   4. Run: php spp.php test:run --app=SPPDocs
 * ============================================================================
 */
