{{--
  ...
  Edit this file: src/SPPDocs/resources/views/home.blade.php
--}}
@extends('layouts.app')
...
@section('content')
    ...
    <div class="card">
        ...
        <p>This form is defined in <code>etc/apps/SPPDocs/forms/contact.yml</code> and rendered via <code>@sppform</code>:</p>
        @sppform('contact')
    </div>
