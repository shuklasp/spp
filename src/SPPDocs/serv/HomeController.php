 ...
 * SPPBlade looks for templates in: src/SPPDocs/resources/views/
 ...
 *   3. Add route in pages.yml: mypage: { controller: \App\SPPDocs\Serv\HomeController@mypage }
 * ============================================================================
 */
class HomeController
{
    ...
    protected function render(string $view, array $data = []): string
    {
        ...
        $data['app_name'] = 'SPPDocs';
        $data['base_url'] = \SPP\App::getBaseUrl('SPPDocs');
