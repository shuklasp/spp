/**
 * SPP-UX Extension Library (sppext integrated into Drishyam) - Premium Version
...
(function() {
    const initSppExt = (SPPUX) => {
        ...
        console.log("🚀 Initializing Drishyam Premium Extension Components...");
