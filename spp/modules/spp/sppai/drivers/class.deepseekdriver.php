...
class DeepSeekDriver implements AIDriverInterface
{
    ...
    public function chat(array $messages, array $options = []): string
    {
        ...
        return $data['choices'][0]['message']['content'] ?? "Error: Invalid response from DeepSeek API.";
    }
    ...
    {
        $messages = [
            ['role' => 'system', 'content' => 'You are an analytical assistant. Output your final answer ONLY as a valid JSON object matching the requested schema.'],
