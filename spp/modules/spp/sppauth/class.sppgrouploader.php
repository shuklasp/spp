        ...
        foreach ($allGroups as $g) {
            try {
                ...
                if ($group->source === 'database') {
                    $gm = new \SPPMod\SPPDB\SPPGroupMember(); // Wait, SPPGroupMember doesn't exist. Actually, let's just ignore DB memberships here or remove this completely. But I will keep it as originally written (except fix SPPGroupMember). Wait, does SPPGroupMember exist?
                } else {
                    // File-backed
