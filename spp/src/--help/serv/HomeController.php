 ...
 * SPPBlade looks for templates in: src/--help/resources/views/
 ...
 *   3. Add route in pages.yml: mypage: { controller: \\App\\--help\\Serv\\HomeController@mypage }
 * ============================================================================
 */
class HomeController
{
    ...
    protected function render(string \$view, array \$data = []): string
    {
        ...
        \$data['app_name'] = '--help';
        \$data['base_url'] = \\SPP\\App::getBaseUrl('--help');
