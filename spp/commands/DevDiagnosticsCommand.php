...
class DevDiagnosticsCommand extends Command
{
    protected string $name = 'dev:diagnostics';
    protected string $description = 'Manage Dev Diagnostics operations. Usage: admin:diagnostics <action> [--payload=...] [--json]';
