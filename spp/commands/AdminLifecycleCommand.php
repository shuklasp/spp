...
class AdminLifecycleCommand extends Command
{
    protected string $name = 'admin:lifecycle';
    protected string $description = 'Manage Admin Lifecycle operations. Usage: admin:lifecycle <action> [--payload=...] [--json]';
    ...
    if (empty($updates)) {
        ...
        ob_start(); require SPP_APP_DIR . '/spp/admin/partials/generated/adminlifecycle_1.php'; $html = ob_get_clean();
    ...
    ob_start(); require SPP_APP_DIR . '/spp/admin/partials/generated/adminlifecycle_2.php'; $html = ob_get_clean();
