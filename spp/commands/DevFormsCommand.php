...
class DevFormsCommand extends Command
{
    protected string $name = 'dev:forms';
    protected string $description = 'Manage Dev Forms operations. Usage: admin:forms <action> [--payload=...] [--json]';
