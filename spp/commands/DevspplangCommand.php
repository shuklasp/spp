...
class DevspplangCommand extends Command
{
    protected string $name = 'dev:spplang';
    protected string $description = 'Manage Dev spplang operations. Usage: admin:spplang <action> [--payload=...] [--json]';
