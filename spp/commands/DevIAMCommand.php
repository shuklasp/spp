...
class DevIAMCommand extends Command
{
    protected string $name = 'dev:iam';
    protected string $description = 'Manage Dev IAM operations. Usage: admin:iam <action> [--payload=...] [--json]';
    ...
    if ($form === 'user_edit') {
        ...
        ob_start(); require SPP_APP_DIR . '/spp/admin/partials/generated/deviam_1.php'; $html = ob_get_clean();
        ...
        ob_start(); require SPP_APP_DIR . '/spp/admin/partials/generated/deviam_2.php'; $html = ob_get_clean();
        ...
        ob_start(); require SPP_APP_DIR . '/spp/admin/partials/generated/deviam_3.php'; $html = ob_get_clean();
    } else if ($form === 'step_editor') {
        ob_start(); require SPP_APP_DIR . '/spp/admin/partials/generated/deviam_4.php'; $html = ob_get_clean();
    } else if ($form === 'field_editor') {
        ob_start(); require SPP_APP_DIR . '/spp/admin/partials/generated/deviam_5.php'; $html = ob_get_clean();
    }
