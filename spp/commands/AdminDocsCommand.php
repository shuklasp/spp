...
class AdminDocsCommand extends Command
{
    protected string $name = 'admin:docs';
    protected string $description = 'Manage Admin Docs operations. Usage: admin:docs <action> [--payload=...] [--json]';
