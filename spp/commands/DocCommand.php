...
class DocCommand extends Command
{
    ...
    public function execute(array $args): void
    {
        ...
        $docDir = file_exists(SPP_APP_DIR . '/spp/modules/optional/sppdoc/src')
            ? SPP_APP_DIR . '/spp/modules/optional/sppdoc/src'
            : SPP_APP_DIR . '/spp/modules/spp/sppdoc/src';

        if ($command === 'docs:build') {
            echo "\n\033[36mBuilding native SPP documentation...\033[0m\n";
            if (!class_exists('\\SPPMod\\SPPDoc\\StaticGenerator')) {
                require_once $docDir . '/DocParser.php';
                require_once $docDir . '/StaticGenerator.php';
            }
        ...
        elseif ($command === 'docs:api') {
            ...
            require_once $docDir . '/SPPRouteDocCollector.php';
            require_once $docDir . '/SPPEntityDocCollector.php';
            require_once $docDir . '/SPPDocGenerator.php';
        ...
        elseif ($command === 'docs:man') {
            ...
            require_once $docDir . '/ManPageGenerator.php';
