...
class DevAdminRBACCommand extends Command
{
    protected string $name = 'dev:adminrbac';
    protected string $description = 'Manage Dev AdminRBAC operations. Usage: dev:adminrbac <action> [--payload=...] [--json]';
