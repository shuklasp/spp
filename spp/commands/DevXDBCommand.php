...
class DevXDBCommand extends Command
{
    protected string $name = 'dev:xdb';
    protected string $description = 'Manage Dev XDB operations. Usage: admin:xdb <action> [--payload=...] [--json]';
