...
class AdminEntitiesCommand extends Command
{
    protected string $name = 'admin:entities';
    protected string $description = 'Manage Admin Entities operations. Usage: admin:entities <action> [--payload=...] [--json]';
