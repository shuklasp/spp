...
class AdminAICommand extends Command
{
    protected string $name = 'admin:ai';
    protected string $description = 'Manage Admin AI operations. Usage: admin:ai <action> [--payload=...] [--json]';
