...
class AdminCoreCommand extends Command
{
    protected string $name = 'admin:core';
    protected string $description = 'Manage Admin Core operations. Usage: admin:core <action> [--payload=...] [--json]';
    ...
    private function handleGetbridgeinfo(array $payload, array $args): void {
        ...
        foreach ($runtimes as $id => &$r) {
            ...
            foreach ($searchNames as $name) {
                ...
                $whereCmd = $isWin ? "where $safeName 2>&1" : "which $safeName 2>&1";
                $out = [];
                $res = null;
