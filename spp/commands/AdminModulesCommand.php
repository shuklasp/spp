...
{
    protected string $name = 'admin:modules';
    protected string $description = 'Manage Admin Modules operations. Usage: admin:modules <action> [--payload=...] [--json]';
    ...
    ob_start(); require SPP_APP_DIR . '/spp/admin/partials/generated/adminmodules_1.php'; $html = ob_get_clean();
