...
class AdminRoutingCommand extends Command
{
    protected string $name = 'admin:routing';
    protected string $description = 'Manage Admin Routing operations. Usage: admin:routing <action> [--payload=...] [--json]';
