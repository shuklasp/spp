...
class DevGeneralCommand extends Command
{
    protected string $name = 'dev:general';
    protected string $description = 'Manage Dev General operations. Usage: admin:general <action> [--payload=...] [--json]';
