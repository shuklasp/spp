...
if (!function_exists('live_list_revisions')) {
    ...
    {
    $res = \SPP\CLI\CommandManager::execute('dev:legacy', ['list_revisions', '--payload' => json_encode($params), '--json' => '1']);
    if ($res['success']) {
...
if (!function_exists('live_ai_parse_scaffold')) {
    ...
    {
    $res = \SPP\CLI\CommandManager::execute('dev:legacy', ['ai_parse_scaffold', '--payload' => json_encode($params), '--json' => '1']);
    if ($res['success']) {
        $data = json_decode($res['output'], true);
        if (isset($data['success']) && !$data['success']) {
            $la->setStatus('error')->notify($data['error'] ?? 'Command failed.');
...
if (!function_exists('live_clone_app')) {
    ...
    {
    $res = \SPP\CLI\CommandManager::execute('dev:legacy', ['clone_app', '--payload' => json_encode($params), '--json' => '1']);
    if ($res['success']) {
        $data = json_decode($res['output'], true);
        if (isset($data['success']) && !$data['success']) {
            $la->setStatus('error')->notify($data['error'] ?? 'Command failed.');
...
if (!function_exists('live_scaffold_template')) {
    ...
    {
    $res = \SPP\CLI\CommandManager::execute('dev:legacy', ['scaffold_template', '--payload' => json_encode($params), '--json' => '1']);
    if ($res['success']) {
        $data = json_decode($res['output'], true);
        if (isset($data['success']) && !$data['success']) {
            $la->setStatus('error')->notify($data['error'] ?? 'Command failed.');
...
if (!function_exists('live_tail_logs')) {
    ...
    {
    $res = \SPP\CLI\CommandManager::execute('dev:legacy', ['tail_logs', '--payload' => json_encode($params), '--json' => '1']);
    if ($res['success']) {
        $data = json_decode($res['output'], true);
        if (isset($data['success']) && !$data['success']) {
            $la->setStatus('error')->notify($data['error'] ?? 'Command failed.');
...
if (!function_exists('live_export_app_package')) {
    ...
    {
    $res = \SPP\CLI\CommandManager::execute('dev:legacy', ['export_app_package', '--payload' => json_encode($params), '--json' => '1']);
    if ($res['success']) {
        $data = json_decode($res['output'], true);
        if (isset($data['success']) && !$data['success']) {
            $la->setStatus('error')->notify($data['error'] ?? 'Command failed.');
...
if (!function_exists('live_generate_docker')) {
    ...
    {
    $res = \SPP\CLI\CommandManager::execute('dev:legacy', ['generate_docker', '--payload' => json_encode($params), '--json' => '1']);
    if ($res['success']) {
        $data = json_decode($res['output'], true);
        if (isset($data['success']) && !$data['success']) {
            $la->setStatus('error')->notify($data['error'] ?? 'Command failed.');
...
if (!function_exists('live_compile_workflow')) {
    ...
    {
    $res = \SPP\CLI\CommandManager::execute('dev:legacy', ['compile_workflow', '--payload' => json_encode($params), '--json' => '1']);
    if ($res['success']) {
        $data = json_decode($res['output'], true);
        if (isset($data['success']) && !$data['success']) {
            $la->setStatus('error')->notify($data['error'] ?? 'Command failed.');
...
if (!function_exists('live_generate_sdk')) {
    ...
    {
    $res = \SPP\CLI\CommandManager::execute('dev:legacy', ['generate_sdk', '--payload' => json_encode($params), '--json' => '1']);
    if ($res['success']) {
        $data = json_decode($res['output'], true);
        if (isset($data['success']) && !$data['success']) {
            $la->setStatus('error')->notify($data['error'] ?? 'Command failed.');
...
if (!function_exists('live_scaffold_test')) {
    ...
    {
    $res = \SPP\CLI\CommandManager::execute('dev:legacy', ['scaffold_test', '--payload' => json_encode($params), '--json' => '1']);
    if ($res['success']) {
        $data = json_decode($res['output'], true);
        if (isset($data['success']) && !$data['success']) {
            $la->setStatus('error')->notify($data['error'] ?? 'Command failed.');
...
if (!function_exists('live_scaffold_auth')) {
    ...
    {
    $res = \SPP\CLI\CommandManager::execute('dev:legacy', ['scaffold_auth', '--payload' => json_encode($params), '--json' => '1']);
    if ($res['success']) {
        $data = json_decode($res['output'], true);
        if (isset($data['success']) && !$data['success']) {
            $la->setStatus('error')->notify($data['error'] ?? 'Command failed.');
...
if (!function_exists('live_ai_generate_logic')) {
    ...
    {
    $res = \SPP\CLI\CommandManager::execute('dev:legacy', ['ai_generate_logic', '--payload' => json_encode($params), '--json' => '1']);
    if ($res['success']) {
        $data = json_decode($res['output'], true);
        if (isset($data['success']) && !$data['success']) {
            $la->setStatus('error')->notify($data['error'] ?? 'Command failed.');
...
if (!function_exists('live_restore_revision')) {
    ...
    {
    $res = \SPP\CLI\CommandManager::execute('dev:legacy', ['restore_revision', '--payload' => json_encode($params), '--json' => '1']);
    if ($res['success']) {
        $data = json_decode($res['output'], true);
        if (isset($data['success']) && !$data['success']) {
            $la->setStatus('error')->notify($data['error'] ?? 'Command failed.');
...
if (!function_exists('live_magic_generate_schema')) {
    ...
    {
    $res = \SPP\CLI\CommandManager::execute('dev:legacy', ['magic_generate_schema', '--payload' => json_encode($params), '--json' => '1']);
    if ($res['success']) {
        $data = json_decode($res['output'], true);
        if (isset($data['success']) && !$data['success']) {
            $la->setStatus('error')->notify($data['error'] ?? 'Command failed.');
...
if (!function_exists('live_scaffold_dashboard')) {
    ...
    {
    $res = \SPP\CLI\CommandManager::execute('dev:legacy', ['scaffold_dashboard', '--payload' => json_encode($params), '--json' => '1']);
    if ($res['success']) {
        $data = json_decode($res['output'], true);
        if (isset($data['success']) && !$data['success']) {
            $la->setStatus('error')->notify($data['error'] ?? 'Command failed.');
...
if (!function_exists('live_preview_migration')) {
    ...
    {
    $res = \SPP\CLI\CommandManager::execute('dev:legacy', ['preview_migration', '--payload' => json_encode($params), '--json' => '1']);
    if ($res['success']) {
        $data = json_decode($res['output'], true);
        if (isset($data['success']) && !$data['success']) {
            $la->setStatus('error')->notify($data['error'] ?? 'Command failed.');
...
if (!function_exists('live_check_auth')) {
    ...
    {
    $res = \SPP\CLI\CommandManager::execute('dev:legacy', ['check_auth', '--payload' => json_encode($params), '--json' => '1']);
    if ($res['success']) {
        $data = json_decode($res['output'], true);
        if (isset($data['success']) && !$data['success']) {
            $la->setStatus('error')->notify($data['error'] ?? 'Command failed.');
...
if (!function_exists('live_get_profile')) {
    ...
    {
    $res = \SPP\CLI\CommandManager::execute('dev:legacy', ['get_profile', '--payload' => json_encode($params), '--json' => '1']);
    if ($res['success']) {
        $data = json_decode($res['output'], true);
        if (isset($data['success']) && !$data['success']) {
            $la->setStatus('error')->notify($data['error'] ?? 'Command failed.');
...
if (!function_exists('live_get_config_all')) {
    ...
    {
    $res = \SPP\CLI\CommandManager::execute('dev:legacy', ['get_config_all', '--payload' => json_encode($params), '--json' => '1']);
    if ($res['success']) {
        $data = json_decode($res['output'], true);
        if (isset($data['success']) && !$data['success']) {
            $la->setStatus('error')->notify($data['error'] ?? 'Command failed.');
...
if (!function_exists('live_get_global_settings')) {
    ...
    {
    $res = \SPP\CLI\CommandManager::execute('dev:legacy', ['get_global_settings', '--payload' => json_encode($params), '--json' => '1']);
    if ($res['success']) {
        $data = json_decode($res['output'], true);
        if (isset($data['success']) && !$data['success']) {
            $la->setStatus('error')->notify($data['error'] ?? 'Command failed.');
...
if (!function_exists('live_save_global_settings')) {
    ...
    {
    $res = \SPP\CLI\CommandManager::execute('dev:legacy', ['save_global_settings', '--payload' => json_encode($params), '--json' => '1']);
    if ($res['success']) {
        $data = json_decode($res['output'], true);
        if (isset($data['success']) && !$data['success']) {
            $la->setStatus('error')->notify($data['error'] ?? 'Command failed.');
...
if (!function_exists('live_save_config_value')) {
    ...
    {
    $res = \SPP\CLI\CommandManager::execute('dev:legacy', ['save_config_value', '--payload' => json_encode($params), '--json' => '1']);
    if ($res['success']) {
        $data = json_decode($res['output'], true);
        if (isset($data['success']) && !$data['success']) {
            $la->setStatus('error')->notify($data['error'] ?? 'Command failed.');
...
if (!function_exists('live_list_commands')) {
    function live_list_commands($la, $params)
    {
    $res = \SPP\CLI\CommandManager::execute('dev:legacy', ['list_commands', '--payload' => json_encode($params), '--json' => '1']);
    if ($res['success']) {
        $data = json_decode($res['output'], true);
        if (isset($data['success']) && !$data['success']) {
            $la->setStatus('error')->notify($data['error'] ?? 'Command failed.');
...
if (!function_exists('live_get_command_ui')) {
    ...
    {
    $res = \SPP\CLI\CommandManager::execute('dev:legacy', ['get_command_ui', '--payload' => json_encode($params), '--json' => '1']);
    if ($res['success']) {
        $data = json_decode($res['output'], true);
        if (isset($data['success']) && !$data['success']) {
            $la->setStatus('error')->notify($data['error'] ?? 'Command failed.');
...
if (!function_exists('live_execute_command')) {
    ...
    {
    $res = \SPP\CLI\CommandManager::execute('dev:legacy', ['execute_command', '--payload' => json_encode($params), '--json' => '1']);
    if ($res['success']) {
        $data = json_decode($res['output'], true);
        if (isset($data['success']) && !$data['success']) {
            $la->setStatus('error')->notify($data['error'] ?? 'Command failed.');
...
if (!function_exists('live_get_builder_context')) {
    ...
    {
    $res = \SPP\CLI\CommandManager::execute('dev:legacy', ['get_builder_context', '--payload' => json_encode($params), '--json' => '1']);
    if ($res['success']) {
        $data = json_decode($res['output'], true);
        if (isset($data['success']) && !$data['success']) {
            $la->setStatus('error')->notify($data['error'] ?? 'Command failed.');
...
if (!function_exists('live_list_entities')) {
    ...
    {
    $res = \SPP\CLI\CommandManager::execute('dev:legacy', ['list_entities', '--payload' => json_encode($params), '--json' => '1']);
    if ($res['success']) {
        $data = json_decode($res['output'], true);
        if (isset($data['success']) && !$data['success']) {
            $la->setStatus('error')->notify($data['error'] ?? 'Command failed.');
...
if (!function_exists('live_parse_entity_yaml')) {
    ...
    {
    $res = \SPP\CLI\CommandManager::execute('dev:legacy', ['parse_entity_yaml', '--payload' => json_encode($params), '--json' => '1']);
    if ($res['success']) {
        $data = json_decode($res['output'], true);
        if (isset($data['success']) && !$data['success']) {
            $la->setStatus('error')->notify($data['error'] ?? 'Command failed.');
...
if (!function_exists('live_dump_entity_yaml')) {
    ...
    {
    $res = \SPP\CLI\CommandManager::execute('dev:legacy', ['dump_entity_yaml', '--payload' => json_encode($params), '--json' => '1']);
    if ($res['success']) {
        $data = json_decode($res['output'], true);
        if (isset($data['success']) && !$data['success']) {
            $la->setStatus('error')->notify($data['error'] ?? 'Command failed.');
...
if (!function_exists('live_introspect_table')) {
    ...
    {
    $res = \SPP\CLI\CommandManager::execute('dev:legacy', ['introspect_table', '--payload' => json_encode($params), '--json' => '1']);
    if ($res['success']) {
        $data = json_decode($res['output'], true);
        if (isset($data['success']) && !$data['success']) {
            $la->setStatus('error')->notify($data['error'] ?? 'Command failed.');
...
if (!function_exists('live_scaffold_form')) {
    ...
    {
    $res = \SPP\CLI\CommandManager::execute('dev:legacy', ['scaffold_form', '--payload' => json_encode($params), '--json' => '1']);
    if ($res['success']) {
        $data = json_decode($res['output'], true);
        if (isset($data['success']) && !$data['success']) {
            $la->setStatus('error')->notify($data['error'] ?? 'Command failed.');
...
if (!function_exists('live_seed_entity')) {
    ...
    {
    $res = \SPP\CLI\CommandManager::execute('dev:legacy', ['seed_entity', '--payload' => json_encode($params), '--json' => '1']);
    if ($res['success']) {
        $data = json_decode($res['output'], true);
        if (isset($data['success']) && !$data['success']) {
            $la->setStatus('error')->notify($data['error'] ?? 'Command failed.');
...
if (!function_exists('live_save_entity_config')) {
    ...
    {
    $res = \SPP\CLI\CommandManager::execute('dev:legacy', ['save_entity_config', '--payload' => json_encode($params), '--json' => '1']);
    if ($res['success']) {
        $data = json_decode($res['output'], true);
        if (isset($data['success']) && !$data['success']) {
            $la->setStatus('error')->notify($data['error'] ?? 'Command failed.');
...
if (!function_exists('live_save_entity_source')) {
    ...
    {
    $res = \SPP\CLI\CommandManager::execute('dev:legacy', ['save_entity_source', '--payload' => json_encode($params), '--json' => '1']);
    if ($res['success']) {
        $data = json_decode($res['output'], true);
        if (isset($data['success']) && !$data['success']) {
            $la->setStatus('error')->notify($data['error'] ?? 'Command failed.');
...
if (!function_exists('live_delete_entity')) {
    ...
    {
    $res = \SPP\CLI\CommandManager::execute('dev:legacy', ['delete_entity', '--payload' => json_encode($params), '--json' => '1']);
    if ($res['success']) {
        $data = json_decode($res['output'], true);
        if (isset($data['success']) && !$data['success']) {
            $la->setStatus('error')->notify($data['error'] ?? 'Command failed.');
...
if (!function_exists('live_list_forms')) {
    ...
    {
    $res = \SPP\CLI\CommandManager::execute('dev:legacy', ['list_forms', '--payload' => json_encode($params), '--json' => '1']);
    if ($res['success']) {
        $data = json_decode($res['output'], true);
        if (isset($data['success']) && !$data['success']) {
            $la->setStatus('error')->notify($data['error'] ?? 'Command failed.');
...
if (!function_exists('live_parse_form_yaml')) {
    ...
    {
    $res = \SPP\CLI\CommandManager::execute('dev:legacy', ['parse_form_yaml', '--payload' => json_encode($params), '--json' => '1']);
    if ($res['success']) {
        $data = json_decode($res['output'], true);
        if (isset($data['success']) && !$data['success']) {
            $la->setStatus('error')->notify($data['error'] ?? 'Command failed.');
...
if (!function_exists('live_dump_form_yaml')) {
    ...
    {
    $res = \SPP\CLI\CommandManager::execute('dev:legacy', ['dump_form_yaml', '--payload' => json_encode($params), '--json' => '1']);
    if ($res['success']) {
        $data = json_decode($res['output'], true);
        if (isset($data['success']) && !$data['success']) {
            $la->setStatus('error')->notify($data['error'] ?? 'Command failed.');
...
if (!function_exists('live_save_form_config')) {
    ...
    {
    $res = \SPP\CLI\CommandManager::execute('dev:legacy', ['save_form_config', '--payload' => json_encode($params), '--json' => '1']);
    if ($res['success']) {
        $data = json_decode($res['output'], true);
        if (isset($data['success']) && !$data['success']) {
            $la->setStatus('error')->notify($data['error'] ?? 'Command failed.');
...
if (!function_exists('live_delete_form')) {
    ...
    {
    $res = \SPP\CLI\CommandManager::execute('dev:legacy', ['delete_form', '--payload' => json_encode($params), '--json' => '1']);
    if ($res['success']) {
        $data = json_decode($res['output'], true);
        if (isset($data['success']) && !$data['success']) {
            $la->setStatus('error')->notify($data['error'] ?? 'Command failed.');
...
if (!function_exists('live_get_form_html')) {
    ...
    {
    $res = \SPP\CLI\CommandManager::execute('dev:legacy', ['get_form_html', '--payload' => json_encode($params), '--json' => '1']);
    if ($res['success']) {
        $data = json_decode($res['output'], true);
        if (isset($data['success']) && !$data['success']) {
            $la->setStatus('error')->notify($data['error'] ?? 'Command failed.');
...
if (!function_exists('live_save_app_config')) {
    ...
    {
    $res = \SPP\CLI\CommandManager::execute('dev:legacy', ['save_app_config', '--payload' => json_encode($params), '--json' => '1']);
    if ($res['success']) {
        $data = json_decode($res['output'], true);
        if (isset($data['success']) && !$data['success']) {
            $la->setStatus('error')->notify($data['error'] ?? 'Command failed.');
...
if (!function_exists('live_list_modules')) {
    ...
    {
    $res = \SPP\CLI\CommandManager::execute('dev:legacy', ['list_modules', '--payload' => json_encode($params), '--json' => '1']);
    if ($res['success']) {
        $data = json_decode($res['output'], true);
        if (isset($data['success']) && !$data['success']) {
            $la->setStatus('error')->notify($data['error'] ?? 'Command failed.');
...
if (!function_exists('live_toggle_module')) {
    ...
    {
    $res = \SPP\CLI\CommandManager::execute('dev:legacy', ['toggle_module', '--payload' => json_encode($params), '--json' => '1']);
    if ($res['success']) {
        $data = json_decode($res['output'], true);
        if (isset($data['success']) && !$data['success']) {
            $la->setStatus('error')->notify($data['error'] ?? 'Command failed.');
...
if (!function_exists('live_execute_scaffold')) {
    ...
    {
    $res = \SPP\CLI\CommandManager::execute('dev:legacy', ['execute_scaffold', '--payload' => json_encode($params), '--json' => '1']);
    if ($res['success']) {
        $data = json_decode($res['output'], true);
        if (isset($data['success']) && !$data['success']) {
            $la->setStatus('error')->notify($data['error'] ?? 'Command failed.');
...
if (!function_exists('live_get_di_bindings')) {
    ...
    {
    $res = \SPP\CLI\CommandManager::execute('dev:legacy', ['get_di_bindings', '--payload' => json_encode($params), '--json' => '1']);
    if ($res['success']) {
        $data = json_decode($res['output'], true);
        if (isset($data['success']) && !$data['success']) {
            $la->setStatus('error')->notify($data['error'] ?? 'Command failed.');
