...
export function activateStubSynchronizer(context: vscode.ExtensionContext) {
    let disposable = vscode.commands.registerCommand('spp.findStub', async (uri?: vscode.Uri) => {
        ...
        if (lowerName.endsWith('controller.php')) {
            if (lowerName.includes('api')) stubTargetName = 'apicontroller.stub';
            else if (lowerName.includes('dashboard')) stubTargetName = 'dashboardcontroller.stub';
            else if (lowerName.includes('auth')) stubTargetName = 'authcontroller.stub';
            else if (lowerName.includes('home')) stubTargetName = 'homecontroller.stub';
            else stubTargetName = 'controller.stub'; // or scaffold_controller.stub depending on context
