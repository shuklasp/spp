...
exports.SPPCompletionItemProvider = void 0;
const vscode = require("vscode");
const path = require("path");
const fs = require("fs");
class SPPCompletionItemProvider {
...
exports.SPPCompletionItemProvider = SPPCompletionItemProvider;
