...
exports.ParikshakProvider = void 0;
const vscode = require("vscode");
const fs = require("fs");
const path = require("path");
const child_process_1 = require("child_process");
class ParikshakProvider {
    ...
    async runHandler(request, token) {
        ...
        const queueItem = (item) => {
            if (request.include && !request.include.includes(item)) {
                ...
                item.children.forEach(c => { if (request.include.includes(c))
                    childIncluded = true; });
                if (!childIncluded)
                    return;
            }
        ...
        (0, child_process_1.exec)('php spp.php test', { cwd: this.workspaceRoot }, (error, stdout, stderr) => {
            const output = stdout + '\n' + stderr;
    ...
    matchSignatureToTestId(signature, queue) {
...
exports.ParikshakProvider = ParikshakProvider;
//# sourceMappingURL=ParikshakProvider.js.map